...
plotfile <- paste(datapath,'plots','nummodels_tickets_boxplot.pdf',sep="/")
pdf(plotfile, height=3, width=3)
par(mar=c(2.5,3.2,0.5,0.1), mgp=c(1.2,0.2,0), cex=1.4)
boxplot(y~x, range=2, ylab='# of Tickets', xlab='# of Models', 
